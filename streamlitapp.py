...
model = pickle.load(open('C:/Users/Cicada 3301/Desktop/AI_Assignment3/TrainedModel.pkl'))
...
def main():
    ...
    with open('C:/Users/Cicada 3301/Desktop/AI_Assignment3/churn_prediction.html') as f:
        html_content = f.read()
